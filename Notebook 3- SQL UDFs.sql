...
-- MAGIC
-- MAGIC * Defined and registering SQL UDFs
-- MAGIC * Described the security model used for sharing SQL UDFs
-- MAGIC * Used **`CASE`** / **`WHEN`** statements in SQL code
-- MAGIC * Leveraged **`CASE`** / **`WHEN`** statements in SQL UDFs for custom control flow

-- COMMAND ----------

-- MAGIC %run ./Includes/Test-Setup-02.7A
